...
namespace Zeebe.Client.Api.Commands
{
    ...
    public interface ICreateWorkflowInstanceCommandStep3 : IFinalCommandStep<IWorkflowInstanceResponse>
    {
        ...
        /// <returns>the builder for this command. Call <see cref="IFinalCommandStep.Send"/> to complete the command and send
        ...
        /// </summary>
        /// <returns>the builder for this command. Call <see cref="FinalCommandStep#send"/> to complete the command and send it to the broker</returns>
        ...
        : IFinalCommandStep<IWorkflowInstanceResult>
    {
        ...
        /// <returns>the builder for this command. Call <see cref="IFinalCommandStep.Send"/> to complete the command and send it to the broker</returns>
